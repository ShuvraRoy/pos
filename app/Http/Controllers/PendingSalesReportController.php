...
class PendingSalesReportController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['sub_menu'] = "Pendiente";
        return view('backend.reports.pending_sales_report', $data);
    }
    ...
    public function fetch_pending_sales_report_data(Request $request)
    {
        $from = $request->from;
        $to = $request->to;
