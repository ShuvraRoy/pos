...
@section('page_header','Agregar Servicio')
@section('page_links')
...
@section('page_content')
    ...
    <form class="bs-example form-horizontal" role="form" action="{{url('add_service/store')}}" id="formaVenta" method="post">
        @csrf
        <div class="row">
            <div class="col-md-4">
    ...
    <div class="modal fade" id="modal-clientes">
        <div class="modal-dialog">
            <form action="{{url('add_service/store_client')}}" class="form-horizontal form-groups-bordered validate"
    ...
    <div class="modal fade" id="modal-articulo">
        <div class="modal-dialog">
            <form action="{{url('add_service/store_inventory')}}" class="form-horizontal form-groups-bordered validate"
                  method="post" role="form" id="add_user_form">
                @csrf
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-md-9"><input type="text" name="servicio_nombre" class="form-control" placeholder=""></div>
                            </div>
                            <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function ($) {
            ...
            }).on('change', function()
            {
                ...
                $.ajax({
                    type : 'get',
                    url : '{{ url("add_service/get_article_data") }}',
                    data : {'id':article_id},
                    datatype: 'json',
            ...
            if ($("#pagocon").val() == ""){
                if ($("#cliente").val() != ""){
                    if($("#productos tr").length > 1){
                        ...
                        $("#errorArticulo").show(); $("#errorMensaje").hide();
                    }
                }else {
                    $("#errorCliente").show();
                }
