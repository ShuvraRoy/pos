...
@section('page_content')
    ...
    <div class="panel panel-primary" data-collapsed="0">
        <div class="panel-body">
            ...
            <div id="add_inventory_modal" class="modal fade"
                 role="dialog" tabindex="-1">
                <div class="modal-dialog">

                    <!-- Modal content-->
                    <form action="{{url('inventory/store')}}" class="form-horizontal form-groups-bordered validate"
                          method="post" role="form" id="add_inventory_form">
                        @csrf
...
{{--                                                  placeholder=""></textarea>--}}
            ...
            <div id="edit_inventory_modal" class="modal fade"
                 role="dialog" tabindex="-1">
                <div class="modal-dialog">

                    <!-- Modal content-->
                    <form action="{{url('inventory/update')}}" class="form-horizontal form-groups-bordered validate"
                          method="post" role="form" id="edit_inventory_form">
                        @csrf
                        <div class="modal-content">
                            <div class="modal-header">
            ...
            <div id="delete_inventory_modal" class="modal fade"
                 role="dialog" tabindex="-1">
                <div class="modal-dialog">

                    <!-- Modal content-->
                    <form action="{{url('inventory/delete')}}" class="form-horizontal form-groups-bordered validate"
                          method="post" role="form" id="delete_inventory_form">
                        @csrf
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="hidden" id="delete_inventory_id" name="delete_inventory_id">
                            </div>
                            <div class="modal-footer">
