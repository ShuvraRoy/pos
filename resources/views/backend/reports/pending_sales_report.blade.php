...
@section('page_header','Reportes de Ventas Pendientes')
@section('page_links')
...
@section('page_content')
    ...
    <div class="panel panel-primary" data-collapsed="0">
        <form action="{{url('pending_sales_report/date_filter')}}" method="post">
            @csrf
        ...
        <div class="table-responsive">
            <table class="table table-bordered datatable" id="pending_sales_report_table">
                <thead>
...
@section('page_scripts')
    ...
    <script type="text/javascript">
        ...
        function initialise_table() {
            var sales_report_table = jQuery("#pending_sales_report_table");
            ...
            sales_report_table.DataTable({
                ...
                "ajax": {
                    "type": 'POST',
                    url:'{{ url("pending_sales_report/get_pending_sales_report_data") }}',
                    "data" : {
                        "_token": "{{ csrf_token() }}",
                        from:from,
                        to:to
