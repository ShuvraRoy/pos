...
@section('page_header','Reportes de Ventas Liquidadas')
@section('page_links')
...
@section('page_content')
    ...
    <div class="panel panel-primary" data-collapsed="0">
        <form action="{{url('cleared_sales_report/date_filter')}}" method="post">
            @csrf
        ...
        <div class="table-responsive">
            <table class="table table-bordered datatable" id="cleared_sales_report_table">
                <thead>
...
@section('page_scripts')
    ...
    <script type="text/javascript">
        ...
        function initialise_table() {
            var sales_report_table = jQuery("#cleared_sales_report_table");
            ...
            sales_report_table.DataTable({
                ...
                "ajax": {
                    "type": 'POST',
                    url:'{{ url("cleared_sales_report/get_cleared_sales_report_data") }}',
                    "data" : {
                        "_token": "{{ csrf_token() }}",
                        from:from,
                        to:to
            ...
            sales_report_table.closest('.dataTables_wrapper').find('select').select2({
