...
@section('page_header','Reporte de Ventas')
@section('page_links')
...
@section('page_content')
    ...
    <div class="panel panel-primary" data-collapsed="0">
        <form action="{{url('sales_report/date_filter')}}" method="post">
            @csrf
        ...
        <div class="table-responsive">
            <table class="table table-bordered datatable" id="sales_report_table">
                <thead>
