            ...
            <section class="panel panel-default">
                ...
                <div class="panel-body">
                    @foreach ($sales_info as $sales)
                        ...
                        <div class="col-md-12">
                            <form role="form" action="{{url('orders/edit_status')}}" class="form-horizontal" method="post">
                                @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            @foreach ($delivery_info as $delivery)
                                ...
                                <form role="form" action="{{url('orders/edit_delivery')}}" class="form-horizontal" method="post">
                                    @csrf
                                    <div class="form-group">
